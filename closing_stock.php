		...
		<div class="wrapper">
			...
			<p class="msg"> 
				<?php
					if($_SERVER['REQUEST_METHOD'] == 'POST'){
						...
						if(empty($year) or empty($id) or empty($sk)){
							echo "<span style='color:#e53d37'>Error...Field Must Not Be Empty</span>";
						} else {
							$cloStk = $user->closinStock($year,$id,$sk);
						    if($cloStk){
								echo "<span style='color:green'>Closing Stock Added</span>";
							} else {
			...
			<div class="random_table"> 
				<form action="" method="post">
					...
					<tr>
							<td>Closing Stock</td>
							<td><input type="varchar" name="closing_sk" /></td>
						</tr>
						<tr>
							<td colspan="2"> 
