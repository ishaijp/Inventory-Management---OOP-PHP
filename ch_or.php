			 	...
			 	<table class="tbl_wrapper">
				   ...
				   <tr>
					...
					<table class="tbl_inv">
					  ...
					  <form action="ch_or.php" method="post">
					...
					if($_SERVER['REQUEST_METHOD'] == 'POST'){	
					  ...
					  <?php
			   $getIn = $pro->getInById2($date);
			   foreach($getIn as $pro){
				   ?>
				<tr>
				    <td><?php echo $pro['OrId']; ?></td>
					...
					<td><a href="ch_or.php?action=delete&id=<?php echo $pro['OrId'];?>">Del</a></td>
					<td><a href="generate.php?id=<?php echo $pro['InId'];?>" target="_blank">GeN</a></td>
				</tr>
					<?php } } ?>
               </table>
			 </div>
