				...
				<?php
					if($_SERVER['REQUEST_METHOD'] == 'POST'){
						...
						if(empty($name) or empty($address) or empty($phone) or empty($email) or empty($company)){
							...
							$addcus = $user->addVen($name,$address,$phone,$email,$company);
						    if($addcus){
...
<form action="" method="post">
					<table>
						<tr>
							<td>Name</td>
							<td><input type="text" name="name" placeholder="Please Enter Vendor Name" /></td>
						</tr>
						
						<tr>
							<td>Address</td>
							<td><input type="text" name="address" placeholder="Please Enter Vendor Address" /></td>
						</tr>

						<tr>
							<td>Phone No.</td>
							<td><input type="text" name="phone" placeholder="Please Enter Vendor Phone No." /></td>
						</tr>						
						
						<tr>
							<td>Email</td>
							<td><input type="email" name="email" placeholder="Please Enter Vendor Email" /></td>
						</tr>		

						<tr>
							<td>Company</td>
							<td><input type="text" name="company" placeholder="Please Enter Vendor Company Name" /></td>
						</tr>	
			...
			?>
				<tr>
					...
					<td><a href="updateven.php?id=<?php echo $user['id']; ?>">Edit Profile</a></td>
					<td><a href="vendor.php?action=delete&id=<?php echo $user['id']; ?>">Delete</a></td>
				</tr>	
			   <?php } ?>
               </table>
			</div>
